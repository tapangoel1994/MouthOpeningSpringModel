...
%
%%UPDATE: edited to ensure that A(1) is positive. TG Dec 30th 2021
%%UPDATE: edited to output A = NaN if fit cannot be done. TG Jan 1st 2022
...
if(~isempty(A1))
    ...
    A = NaN; %%return nan if fit cannot be done
end
